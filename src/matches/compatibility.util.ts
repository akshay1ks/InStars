 ...
 */
export function compatibilityPercent(me: User, other: User): number {
  let earned = 0;
  let possible = 0;
  ...
  if (me.relationshipType && other.relationshipType) {
    possible += 30;
    if (me.relationshipType === other.relationshipType) earned += 30;
  }
...
export function profileTile(
  ...
  const dist =
    me.latitude != null && other.latitude != null
